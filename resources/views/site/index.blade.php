                    ...
                    <div class="slider__container slider--one">
                        <div class="slider__activation__wrap owl-carousel owl-theme">
                            ...
                            <div class="slide slider__full--screen slider-height-inherit slider-text-right"
                                style="background: rgba(0, 0, 0, 0) url({{ asset('siteasset/images/slider/bg/1.png') }}) no-repeat scroll center center / cover ;">
                                <div class="container">
                                    <div class="row">
                                        <div
                            ...
                            <div class="slide slider__full--screen slider-height-inherit  slider-text-left"
                                style="background: rgba(0, 0, 0, 0) url({{ asset('siteasset/images/slider/bg/2.png') }}) no-repeat scroll center center / cover ;">
                                <div class="container">
                                    <div class="row">
                ...
                <div class="col-md-3 col-lg-3 col-sm-4 col-xs-12 float-right-style">
                    <div class="categories-menu mrg-xs">
                        ...
                        <div class="category-menu-list">
                            <ul>
                                <li><a href="#"><img alt=""
                                            src=" {{ asset('siteasset/images/icons/thum2.png') }}"> Women’s Clothing <i
                                ...
                                <li><a href="#"><img alt=""
                                            src=" {{ asset('siteasset/images/icons/thum3.png') }}"> Man Fashion <i
                                            class="zmdi zmdi-chevron-right"></i></a>
                                    <div class="category-menu-dropdown">
                                        ...
                                        <div class="mega-banner-img">
                                            <a href="single-product.html">
                                                <img src=" {{ asset('siteasset/images/feature-img/5.jpg') }}"
                                                    alt="">
                                            </a>
                                        </div>
                                    </div>
                                ...
                                <li><a href="#"><img alt=""
                                            src=" {{ asset('siteasset/images/icons/thum4.png') }}"> Computer & Office <i
                                            class="zmdi zmdi-chevron-right"></i></a>
                                    <div class="category-menu-dropdown">
                                        ...
                                        <div class="category-menu-dropdown-bottom">
                                            <div class="single-category-brand">
                                                <a href="#"><img src=" {{ asset('siteasset/images/brand/6.png') }}"
                                                        alt=""></a>
                                            </div>
                                            <div class="single-category-brand">
                                                <a href="#"><img src=" {{ asset('siteasset/images/brand/7.png') }}"
                                                        alt=""></a>
                                            </div>
                                            <div class="single-category-brand">
                                                <a href="#"><img src=" {{ asset('siteasset/images/brand/8.png') }}"
                                                        alt=""></a>
                                            </div>
                                            <div class="single-category-brand">
                                                <a href="#"><img src=" {{ asset('siteasset/images/brand/9.png') }}"
                                                        alt=""></a>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <li><a href="#"><img alt=""
                                            src=" {{ asset('siteasset/images/icons/thum5.png') }}"> Jewelry & Watches <i
                                            class="zmdi zmdi-chevron-right"></i></a>
                                    <div class="category-menu-dropdown">
                                        ...
                                        <div class="category-menu-dropdown-right">
                                            <div class="menu-right-img">
                                                <a href="#"><img
                                                        src=" {{ asset('siteasset/images/feature-img/2.png') }}"
                                                        alt=""></a>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <li><a href="#"><img alt=""
                                            src=" {{ asset('siteasset/images/icons/thum6.png') }}"> Men’s Clothing <i
                                            class="zmdi zmdi-chevron-right"></i></a>
                                    <div class="category-menu-dropdown">
                                        <div class="category-menu-dropdown-left">
                                        ...
                                        <div class="category-menu-dropdown-right">
                                            <div class="menu-right-img">
                                                <a href="#"><img
                                                        src=" {{ asset('siteasset/images/feature-img/1.png') }}"
                                                        alt=""></a>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <li><a href="#"><img alt=""
                                            src=" {{ asset('siteasset/images/icons/thum7.png') }}"> Bags & Shoes</a></li>
                                <li><a href="#"><img alt=""
                                            src=" {{ asset('siteasset/images/icons/thum8.png') }}"> Toys & Kids & Baby</a>
                                </li>
                                <li><a href="#"><img alt=""
                                            src=" {{ asset('siteasset/images/icons/thum9.png') }}"> Automobiles </a></li>
                                <li><a href="#"><img alt=""
                                            src=" {{ asset('siteasset/images/icons/thum10.png') }}"> Jewelry & Watches</a>
                                </li>
                                <li><a href="#"><img alt=""
                                            src=" {{ asset('siteasset/images/icons/thum2.png') }}"> Consumer
                                        Electronics</a></li>
                                <li><a href="#"><img alt=""
                                            src=" {{ asset('siteasset/images/icons/thum3.png') }}"> all Accessories</a>
                                </li>
                            </ul>
                        </div>
                    </div>
